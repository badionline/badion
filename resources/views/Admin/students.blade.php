    ...
    <div class="container">
        <div class="row">
            <div class="col-sm text-end">
                ...
                <a href="{{ route('apaststudents') }}">
                    <button class="btn card light fa fa-user-graduate" type="button"> Past Students</button>
                </a>
                <a href="{{ route('aexportstudents') }}">
                    <button class="btn card light fa fa-file-excel" type="button"> Download Students</button>
                </a>
            </div>
        </div>
    </div>
    <div class="col-sm container card dark light">
        <div class="table-responsive">
            <table id="students" class="table dark light">
                <thead>
                    <tr>
                        <th scope="col" id="name" class="dark light">School Id</th>
