    ...
    <div class="container">
                    ...
                    <form id="studymaterials">
                        ...
                        <div class="table-responsive container">
                            <table class="table">
                                ...
                                <tr>
                                    <td class="dark light"><input type="text" name="title" class="form-control"
                                            placeholder="Document Title"></td>
                                </tr>
                                <tr>
                                    <td class="dark light">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="card dark">
                    <div class="table-responsive container">
                        <table class="table" id="studymaterial">
                            <thead>
                                <tr>
                                    <th>Subject Name</th>
                                    <th>Title</th>
...
@section('jquery')
    <script>
        $(document).ready(function() {
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#studymaterial').DataTable().ajax.reload();
            ...
            $('#studymaterial').DataTable({
                ajax: {
                    url: '{{ route('studymaterial') }}',
                    dataSrc: '',
                },
                columns: [{
                        data: 'subject'
                    ...
                    {
                        data: 'studymaterial_id',
                        render: function(data, type, row, meta) {
                            return "<div class='d-flex justify-content-end'>" +
                                "<i class='options fa fa-trash deletestudymaterial text-danger' " +
            ...
            $(document).on("click", ".deletestudymaterial", function() {
                var id = $(this).attr("id");
                $.ajax({
                    type: 'post',
                    url: '{{ route('deletestudymaterials') }}',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id: id
                    },
