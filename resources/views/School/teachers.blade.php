    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm text-end">
                <a href="{{ route('saddteacher') }}">
                    <button class="btn card fa fa-plus" type="button"> Add Teacher</button>
                </a>
                <a href="{{ route('pastteachers') }}">
                    <button class="btn card light fa fa-chalkboard-teacher" type="button"> Past
                        Teachers
                    </button>
                </a>
                 <a href="{{route('exportteachers')}}">
                    <button class="btn card fa fa-file-excel" type="button"> Download Teachers File</button>
                </a>
            </div>
        </div>
