                ...
                <div class="card flex-row">
                    <div class="card-body light">
                        ...
                        <form id="assignclass">
                            ...
                            <button type="submit" id="assignteachersubmit" class="btn button">Assign
                                Teacher</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card flex-row dark">
                    <div class="card-body light">
                        ...
                        <div class="container table-responsive">
                            <table id="teacherslist" class="table table-dark">
                                <thead>
                                    <tr>
            ...
            $("#assignclass").validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        success: function(data) {
                            $("#teacherslist").DataTable().ajax.reload();
                            if(data.status==0){
