            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return "<div class='d-flex justify-content-between'>" +
                        "<a href='student/"+data+"'><i class='options fa fa-eye'></i></a></div></td></tr>";//<i class='options fa fa-trash-restore deletestudentclick text-danger' " + "data-toggle='modal' id=" + data + " data-target='#deletestudent'></i>
                },
            },
        ],
        order: false,
