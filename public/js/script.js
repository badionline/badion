document.addEventListener('DOMContentLoaded', function () {
	...
	//             formValid = false;
	//             element.style.borderColor = 'red'; // Apply red border for empty fields
	//         } else {
	//             element.style.borderColor = ''; // Reset border color if valid
	//         }
	//     });
	...
	//         // Once form is submitted, close the modal
	//         document.getElementById('contactFormModal').style.display = 'none';
	//         $.ajax({
	//             type: 'POST',
	...
	//                 window.location.href = 'sendnumber.php';
	//             },
